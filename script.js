...
numberHours.insertAdjacentHTML("afterbegin",nunberElement.join(""));
...
12 hours = 360det so 1hrs = 360 / 12 = 30deg
1 hrs = 30deg that means 60 min = 30deg so 1 min =30 /60 =0.5 or 1/2 deg
so formula fou hours is (hours * 30 minutes / 2
-------------------------------------------) */
...
setInterval(getCurrentTime, 1000);//100ms = 1s
